          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition">
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-center"><CheckCircle className="h-5 w-5 text-green-500 mr-2" />Up to 10 accounts</li>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-500 hover:shadow-xl transition relative">
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-center"><CheckCircle className="h-5 w-5 text-green-500 mr-2" />Up to 50 accounts</li>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition">
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-center"><CheckCircle className="h-5 w-5 text-green-500 mr-2" />Unlimited accounts</li>
